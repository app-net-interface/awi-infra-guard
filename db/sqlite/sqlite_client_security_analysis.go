...
func (client *sqliteClient) SyncVpcPostProcess() error {
...
func (client *sqliteClient) analyzeVPCSecurity(vpcIndex *types.VPCIndex) error {
	if vpcIndex == nil {
...
func (client *sqliteClient) analyzeInstancesSecurity(vpcIndex *types.VPCIndex, securityRisks *types.VPCSecurityRisks) error {
...
func (client *sqliteClient) analyzeInstanceSecurity(instance *types.Instance) *types.InstanceSecurityStatus {
...
func (client *sqliteClient) analyzeSecurityGroupsSecurity(vpcIndex *types.VPCIndex, securityRisks *types.VPCSecurityRisks) error {
...
func (client *sqliteClient) analyzeSecurityGroupSecurity(sg *types.SecurityGroup) *types.SecurityGroupRiskStatus {
...
func (client *sqliteClient) analyzeLoadBalancersSecurity(vpcIndex *types.VPCIndex, securityRisks *types.VPCSecurityRisks) error {
...
func (client *sqliteClient) analyzeLoadBalancerSecurity(lb *types.LB) *types.LoadBalancerSecurityStatus {
...
func (client *sqliteClient) analyzeSubnetsSecurity(vpcIndex *types.VPCIndex, securityRisks *types.VPCSecurityRisks) error {
...
func (client *sqliteClient) analyzeSecurityGroupRules(rules []types.SecurityGroupRule) []string {
	riskyPorts := []string{}
...
func (client *sqliteClient) hasUnrestrictedAccess(sgIds []string) bool {
	if sgIds == nil {
		return false
	}
